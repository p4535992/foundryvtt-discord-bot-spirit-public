...
import com.foundryvtt.bot.spirit.openapi.relay.client.dnd5e.invoker.auth.Authentication;
import com.foundryvtt.bot.spirit.openapi.relay.client.dnd5e.invoker.auth.HttpBasicAuth;
import com.foundryvtt.bot.spirit.openapi.relay.client.dnd5e.invoker.auth.HttpBearerAuth;
import com.foundryvtt.bot.spirit.openapi.relay.client.dnd5e.invoker.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    protected String basePath = "http://localhost:30000";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://localhost:30000)
     ...
     * @return a {@link com.foundryvtt.bot.spirit.openapi.relay.client.dnd5e.invoker.ApiClient} object
     */
    ...
    */
     ...
     * @throws com.foundryvtt.bot.spirit.openapi.relay.client.dnd5e.invoker.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.foundryvtt.bot.spirit.openapi.relay.client.dnd5e.invoker.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.foundryvtt.bot.spirit.openapi.relay.client.dnd5e.invoker.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.foundryvtt.bot.spirit.openapi.relay.client.dnd5e.invoker.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.foundryvtt.bot.spirit.openapi.relay.client.dnd5e.invoker.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.foundryvtt.bot.spirit.openapi.relay.client.dnd5e.invoker.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.foundryvtt.bot.spirit.openapi.relay.client.dnd5e.invoker.ApiException If fails to update the parameters
     */
     ...
     * @throws com.foundryvtt.bot.spirit.openapi.relay.client.dnd5e.invoker.ApiException If fail to serialize the request body object into a string
     */
