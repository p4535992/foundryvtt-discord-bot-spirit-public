...
import com.foundryvtt.bot.spirit.openapi.relay.v13.system.dnd5e.invoker.auth.ApiKeyAuth;
import com.foundryvtt.bot.spirit.openapi.relay.v13.system.dnd5e.invoker.auth.Authentication;
import com.foundryvtt.bot.spirit.openapi.relay.v13.system.dnd5e.invoker.auth.HttpBasicAuth;
...
public class ApiClient {
     ...
     * @return a {@link com.foundryvtt.bot.spirit.openapi.relay.v13.system.dnd5e.invoker.ApiClient}
     *         object
     */
     ...
     * @throws com.foundryvtt.bot.spirit.openapi.relay.v13.system.dnd5e.invoker.ApiException If fail
     *                                                                                       to
     *                                                                                       deserialize
     *                                                                                       response
     *                                                                                       body,
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.foundryvtt.bot.spirit.openapi.relay.v13.system.dnd5e.invoker.ApiException If the
     *                                                                                       response
     *                                                                                       has an
     *                                                                                       unsuccessful
     *                                                                                       status
    ...
    public void processCookieParams(Map<String, String> cookieParams, Request.Builder reqBuilder) {
        for (Entry<String, String> param : cookieParams.entrySet()) {
            reqBuilder.addHeader("Cookie", String.format(java.util.Locale.ROOT, "%s=%s",
     ...
     * @param uri          URI
     * @throws com.foundryvtt.bot.spirit.openapi.relay.v13.system.dnd5e.invoker.ApiException If
     *                                                                                       fails
     *                                                                                       to
     *                                                                                       update
     *                                                                                       the
            ...
            if (!verifyingSsl) {
                ...
                if (tlsServerName != null && !tlsServerName.isEmpty()) {
                    hostnameVerifier = new HostnameVerifier() {
                        @Override
                        public boolean verify(String hostname, SSLSession session) {
                            // Verify the certificate against tlsServerName instead of the actual
                            // hostname
