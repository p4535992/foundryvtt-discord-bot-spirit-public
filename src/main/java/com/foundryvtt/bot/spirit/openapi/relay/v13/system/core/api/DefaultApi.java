...
public class DefaultApi {
    ...
    private okhttp3.Call apiStatusGetValidateBeforeCall(final ApiCallback _callback)
            throws ApiException {
    ...
    /**
     * /api/status (asynchronously) Returns the API status
     * 
     ...
     *                        </table>
     */
    public okhttp3.Call clientsGetCall(@jakarta.annotation.Nullable String xApiKey,
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call clientsGetValidateBeforeCall(@jakarta.annotation.Nullable String xApiKey,
            final ApiCallback _callback) throws ApiException {
    ...
    /**
     * /clients Returns connected client Foundry Worlds
     * 
     * @param xApiKey (optional)
     * @return Object
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
     ...
     *                        </table>
     */
    public ApiResponse<Object> clientsGetWithHttpInfo(@jakarta.annotation.Nullable String xApiKey)
            throws ApiException {
    ...
    /**
     * /clients (asynchronously) Returns connected client Foundry Worlds
     * 
     * @param xApiKey   (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     *                        </table>
     */
    public okhttp3.Call clientsGetAsync(@jakarta.annotation.Nullable String xApiKey,
