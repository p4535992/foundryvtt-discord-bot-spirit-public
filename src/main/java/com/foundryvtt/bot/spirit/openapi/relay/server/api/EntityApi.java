...
public interface EntityApi {
     ...
     * @param createPostRequest parameter value. Response 201: Created
     */
    @POST
    @Path("/create")
    @Consumes({
     ...
     * @param selected parameter value. Response 200: OK
     */
    @DELETE
    @Path("/delete")
    @Produces({
     ...
     * @param actor    Use selected entity&#39;s actor Response 200: OK
     */
    @GET
    @Path("/get")
    @Produces({
    ...
    /**
     * ## Give an item to an actor - Item uuid required - Selected actor or actor uuid - Optionally
     * take from another actor - Optionally specify quantity
     *
     * @param xApiKey  parameter value.
     * @param clientId Auth token to connect to specific Foundry world
     * @param body     parameter value. Response 200: OK
     ...
     * @param clientId    Auth token to connect to specific Foundry world
     * @param selected    parameter value.
     * @param requestBody parameter value. Response 200: OK
     */
    @POST
    @Path("/kill")
    @Consumes({
