...
public class Item {
    ...
    public Item folder(@jakarta.annotation.Nullable String folder) {
        this.folder = folder;
        return this;
    }
    ...
    public Item data(@jakarta.annotation.Nullable Map<String, Object> data) {
        this.data = data;
        return this;
    }
    ...
    public Item flags(@jakarta.annotation.Nullable Map<String, Object> flags) {
        this.flags = flags;
        return this;
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!Item.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is
                                                         // null
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<Item> thisAdapter = gson.getDelegateAdapter(this,
